...
<body>
<img src="product_images/jewellery stock photo.jpg" width="100%">
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="index.php" class="navbar-brand">JEWELLERY CATALOGUE </a>
			</div>
			...
			<div class="col-md-8 col-xs-12">
				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						...
						<!--<div class="col-md-4">
							<div class="panel panel-info">
								<div class="panel-heading">jam suit</div>
								<div class="panel-body">
